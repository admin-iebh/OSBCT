...
window.I18N = {
  ...
  // used to be shown the wrong Atthḁkathā it is now shown nothing, and nothing
  // has to be explained.  The placeholder is the band name, Pāl̥i in both languages.
  ...
  search_ph:{en:'Search Pāḷi — diacritics optional (e.g. nibbana finds nibbāna)',
             es:'Buscar en Pāḷi — diacríticos opcionales (p. ej. nibbana encuentra nibbāna)'},
  opt_all:{en:'All layers',es:'Todas las capas'},
  opt_pali:{en:'Tipiṭaka only',es:'Solo Tipiṭaka'},
  opt_atth:{en:'Aṭṭhakathā only',es:'Solo Aṭṭhakathā'},
  opt_tika:{en:'Ṭīkā only',es:'Solo Ṭīkā'},
  search_btn:{en:'Search',es:'Buscar'},
  search_foot:{en:'Diacritic-insensitive exact / substring search. Type with or without diacritics. Results show location and printed page; click a result to open it in the reader.',
               es:'Búsqueda exacta / por subcadena, insensible a diacríticos. Escriba con o sin diacríticos. Los resultados muestran la ubicación y la página impresa; haga clic en un resultado para abrirlo en el lector.'},
