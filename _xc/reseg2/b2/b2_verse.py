...
reseg = J('_xc/reseg2/%s.json' % VOL)['paragraphs']
verse = J(_PRE('site/reader/verse/%s.json' % VOL))
...
REMAP = J('_xc/reseg2/ord_remap_%s.json' % VOL)
RUNS = {}
...
def build(_opt=None, anchor='design', udd_anchor='last', merge=True,
    ...
    UDD = J(_PRE('site/reader/uddana/%s.json' % VOL))
    udd_hide = []
    udd_tail = []
    _cur = NA[0][2]
    ...
    SEC0 = J(_PRE('site/reader/sections/%s.json' % VOL))
    ...
    old_render = render(ship, verse,
                        J(_PRE('site/reader/uddana/%s.json' % VOL)),
                        J(_PRE('site/reader/sections/%s.json' % VOL)),
                        J(_PRE('site/reader/hide/%s.json' % VOL)),
                        J(_PRE('site/reader/incipit/%s.json' % VOL)),
                        J(_PRE('site/reader/booktitle/%s.json' % VOL)))
    ...
    UDD0 = J(_PRE('site/reader/uddana/%s.json' % VOL))
