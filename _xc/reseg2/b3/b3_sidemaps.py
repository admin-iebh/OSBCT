...
hide = J(_PRE('site/reader/hide/%s.json' % VOL))
...
sec = J(_PRE('site/reader/sections/%s.json' % VOL))
...
inc = J(_PRE('site/reader/incipit/%s.json' % VOL))
btl = J(_PRE('site/reader/booktitle/%s.json' % VOL))
ordm = J(_PRE('site/reader/ord/%s.json' % VOL))
